...
science = glob.glob('/Users/jemcclea/Research/GalSim/examples/output/empirical_psfs/*fits')
...
try:
    ...
    bm.set_working_dir(path='mock_data')
    bm.set_path_to_psf(path='mock_data/psfex_output')
    """
    bm.set_path_to_calib_data(path='/Users/jemcclea/Research/SuperBIT_2019/A2218/')
    bm.set_path_to_science_data(path='/Users/jemcclea/Research/GalSim/examples/output/empirical_psfs/')
    ...
    """
    bm.run(clobber=False,source_selection = True, select_from_gaia=False)
